...
public class DataAdapter extends RecyclerView.Adapter<DataAdapter.ViewHolder> {
    private ArrayList<ArraySize> arraysize;
    ...
    public DataAdapter(Context context,ArrayList<ArraySize> arraysize) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        Picasso.with(context).load(imageUrls[i]).resize(120, 60).into(viewHolder.img_android);
    }
